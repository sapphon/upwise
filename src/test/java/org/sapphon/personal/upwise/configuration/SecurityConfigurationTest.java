...
public class SecurityConfigurationTest {
    ...
    private static List<String> uiStaticEndpoints = newArrayList("/forgotpassword", "/login", "/randomwisdom", "/viewwisdom?wisdomContent=whatever&wisdomAttribution=whatever", "/", "/user/whatever", "/wisdomleaderboard", "/recentwisdom", "/register", "/scripts/materialize-auto-init.js", "/styles/global.css");
